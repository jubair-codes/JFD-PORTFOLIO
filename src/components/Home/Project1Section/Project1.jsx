    ...
    return (
            <section className='w-full py-50 flex gap-5'>
                ...
                <div className='flex flex-col gap-7 flex-[0.8] justify-center p-10'>
                    <small className='text-green-400 text-[18px]'>-- Project 1</small>
                ...
                <div className="flex-1 flex gap-8 relative">
                   <img src="https://kitpapa.net/freelancer/wp-content/uploads/2023/11/StudioX-Animated-Lawyer-light-WordPress-Elementor-Prsonal-Portfolio-Responsive-template-Thumbnail.jpg" alt="" className='rounded-4xl z-10 relative'/>
